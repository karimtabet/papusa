...
class BlogIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('app.BlogIndexPage', related_name='related_links')
...
class BlogPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('app.BlogPage', related_name='carousel_items')


class BlogPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('app.BlogPage', related_name='related_links')


class BlogPageTag(TaggedItemBase):
    content_object = ParentalKey('app.BlogPage', related_name='tagged_items')
...
class PersonPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('app.PersonPage', related_name='related_links')
...
class EventIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('app.EventIndexPage', related_name='related_links')
...
class EventPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('app.EventPage', related_name='carousel_items')


class EventPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('app.EventPage', related_name='related_links')


class EventPageSpeaker(Orderable, LinkFields):
    page = ParentalKey('app.EventPage', related_name='speakers')
